    ...
    <div class="card shadow-lg">
        <div class="card-header text-white">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="mb-0"><i class="fas fa-users-cog me-2"></i>Meritorious Student Management</h3>
                <div class="d-flex align-items-center">
                    <button class="btn btn-success ms-3 add-new" onclick="location.href='?e=meritorious_st'">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center action-buttons">
                                    <button class="btn btn-sm btn-edit me-1" title="Edit" onclick="location.href='?e=meritorious_st&id=<?= encryptSt($row['id']) ?>'">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('btnConfirmDelete').addEventListener('click', function() {
            ...
            fetch('api/delete.php', {
                ...
                body: JSON.stringify({ id: idToDelete, table: 'meritorious_st' })
            })
