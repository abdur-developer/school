<head>
  ...
  <meta content="<?=$sys['description']?>" name="description">
  <meta content="<?=$sys['keywords']?>" name="keywords">
  <!-- Favicons -->
  <link href="<?=$sys['favicon']?>" rel="icon">
  <link href="<?=$sys['favicon']?>" rel="apple-touch-icon">
  ...
  <meta property="og:image" content="<?=$sys['cover']?>">
